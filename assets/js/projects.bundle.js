const projects = [
    { name: "ubiquitous-guide", image: null, placeholder: { icon: "🧠", label: "ADHD Trading Toolkit" }, description: "Checklist + AI coaching companion for traders with ADHD. Pre-market routines, IF-THEN impulse controls, and a Claude-powered psychology mirror. Built from personal recovery.", url: "https://github.com/singhaidotnish/ubiquitous-guide", color: "#7C3AED" },
