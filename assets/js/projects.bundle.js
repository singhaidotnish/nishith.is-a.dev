const projects = [
    ...
    {name: "mymenu-yt", image: "/assets/projects/mymenu-yt.png", description: "Galaxy-themed radial menu in React + Three.js. Circular pie-menu with 2D/3D toggle — YouTube, AI, Trading & Utilities.", url: "/mymenu-yt/", color: "#ffaa00"}
];
